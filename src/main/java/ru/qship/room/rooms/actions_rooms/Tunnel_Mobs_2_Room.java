...
public class Tunnel_Mobs_2_Room extends Room {

    public Tunnel_Mobs_2_Room(Facing roomFacing, int centerX, int centerY, int centerZ, Room nextRoom) {
        super(
                List.of(new RoomExit(0,0,-10,
                        roomFacing,Facing.NORTH)),
                roomFacing,
                centerX, centerY, centerZ,
                SchematicManager.schematic(new File("./schematics/tunnel2_mobs.schem")),
                nextRoom);
    }
